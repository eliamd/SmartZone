...
<section class="py-8">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">Votre nouveau smartphone neuf<br> a un <mark class="underline underline-offset-3 decoration-8 decoration-orange-400 bg-white">prix unique</mark></h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl ">Envie de faire de sérieuses économies sur votre futur smartphone ? Grâce à SmartZone obtenez un nouveau smartphone neuf au prix le plus bas du marché avec une expérience unique.</p>
...
<section class="my-20">
  ...
  <div class="w-full p-4 text-center bg-white  rounded-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    ...
    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Téléchargez notre application mobile SmartZone disponible pour iPhone et Android</p>
