                        ...
                        <div class='w-full bg-white rounded-lg shadow'>
                            <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
                                ...
                                <div class='p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800' role='alert'>
                                    <span class='font-medium'>Compte créer avec succes ! </span> Vous pouvez désormais vous <a class='underline' href='connexion.php'>connecter.</a>
                                </div>
                            ...
                            <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
                                ...
                                <form class='space-y-4 md:space-y-6' action='inscriptiontraitement.php' method='post'>
                                    ...
                                    <div>
                                        ...
                                        <span class='font-medium'>Prénom invalide. </span>Le nom doit faire entre 3 et 20 caractères.
                                    </div>
                            ...
                            <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
                                ...
                                <form class='space-y-4 md:space-y-6' action='inscriptiontraitement.php' method='post'>
                                    ...
                                    <div>
                                        ...
                                        <div class='p-3 mt-4 text-sm text-red-700 bg-red-300 rounded-lg' role='alert'>
                                            <span class='font-medium'>Les mots de passe ne correspondent pas. </span>Veuillez réessayer.
                                        </div>
                            ...
                            <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
                                ...
                                <form class='space-y-4 md:space-y-6' action='inscriptiontraitement.php' method='post'>
                                    <div>
                                        ...
                                        <input type='email' name='email' id='email' class='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5' placeholder='nom.prenom@gmail.com' required=''>
                                        <div class='p-3 mt-4 text-sm text-red-700 bg-red-300 rounded-lg' role='alert'>
                                            <span class='font-medium'>E-Mail invalide. </span>L'e-mail doit etre au format xxx@xxxx.xx et faire entre 5 et 30 caractères.
                                        </div>
                                    </div>
                                    <div>
                                        <label for='nom' class='block mb-2 text-sm font-medium text-gray-900'>Nom</label>
                        ...
                        <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
                            ...
                            <form class='space-y-4 md:space-y-6' action='inscriptiontraitement.php' method='post'>
                                ...
                                <div>
                                    ...
                                    <input type='text' name='nom' id='nom' class='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5' placeholder='Dupont' required=''>
                                    <div class='p-3 mt-4 text-sm text-red-700 bg-red-300 rounded-lg' role='alert'>
                                        <span class='font-medium'>Nom invalide. </span>Le nom doit faire entre 3 et 20 caractères.
                                    </div>
                        ...
                        <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
                            ...
                            <form class='space-y-4 md:space-y-6' action='inscriptiontraitement.php' method='post'>
                                <div>
                                    ...
                                    <input type='email' name='email' id='email' class='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5' placeholder='nom.prenom@gmail.com' required=''>
                                    <div class='p-3 mt-4 text-sm text-red-700 bg-red-300 rounded-lg' role='alert'>
                                        <span class='font-medium'>Adresse E-Mail déja utilisé. </span><a href="connexion.php" class='underline'>Se connecter</a>
                                    </div>
                                </div>
                                <div>
                                    <label for='nom' class='block mb-2 text-sm font-medium text-gray-900'>Nom</label>
