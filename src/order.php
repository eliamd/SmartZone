...
?>
    ...
    <div class="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        <div class="flex justify-start item-start space-y-2 flex-col">
            <h1 class="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">Commande
                #
                <?php echo $dataorder['order_id']; ?>
            </h1>
            <p class="text-base dark:text-gray-300 font-medium leading-6 text-gray-600">
                <?php echo $dataorder['order_date']; ?>
            </p>
        </div>
        <div
                ...
                <div
                        ...
                        <div
                            ...
                            <div class="flex justify-between w-full">
                                ...
                                <p class="text-base dark:text-gray-300 leading-4 text-gray-600">
                                    <?php echo $dataorder['total_price'] . '.00€'; ?>
                                </p>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-start w-full">
                            <div class="flex justify-center items-center space-x-4">
                                ...
                                <div class="flex flex-col justify-start items-center">
                                    <p class="text-lg leading-6 dark:text-white font-semibold text-gray-800">Livreur :
                                        DPD<br /><span class="font-normal">Livraison en 24 heures</span></p>
                                </div>
                            </div>
                        ...
                        <div class="w-full flex justify-center items-center">
                            <button
                                class="hover:bg-black dark:bg-white dark:text-gray-800 dark:hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full bg-gray-800 text-base font-medium leading-4 text-white">Suivre
                                mon colis</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-start items-start flex-col space-y-2">
                                <p class="text-base dark:text-white font-semibold leading-4 text-left text-gray-800">
                                    <?php echo ucfirst($dataorder['nom']);
                                    echo ' ';
                                    echo ucfirst($dataorder['prenom']); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p
                                    ...
                                    <?php echo $dataorder['address'] . ' ' . $dataorder['postal'] . ' ' . $dataorder['city']; ?>
                                </p>
                            </div>
